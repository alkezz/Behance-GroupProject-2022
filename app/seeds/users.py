...
def seed_users():
    ...
    marnie = User(
        username='marnie', email='marnie@aa.io', password='password', first_name="Marnie", last_name="Mills")
    bobbie = User(
    ...
    francis = User(
        username='franbacon', email='bacon@aa.io', password='password3', first_name='Francis', last_name="Bacon")
