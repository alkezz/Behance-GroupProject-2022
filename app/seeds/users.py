...
def seed_users():
    ...
    project_3 = Project(
        name="Bad Project", description="wow this sucked", user_id=1, project_appreciations=[jimmy, francis, demo], images="[https://i.imgur.com/1YeIqqk.jpg, https://i.imgur.com/QjWyuWM.jpeg, https://i.imgur.com/ERcTRbm.jpeg]"
    )
    project_4 = Project(
